...
.method public static getKey([B[B[B)[B
    ...
    invoke-static {p0, p1}, Lcom/huawei/agconnect/config/impl/Keys;->bytesXor([B[B)[B

    move-result-object p0

    const/4 p1, 0x6

    invoke-static {p0, p1}, Lcom/huawei/agconnect/config/impl/Keys;->bytesShift([BI)[B

    move-result-object p0

    invoke-static {p0, p2}, Lcom/huawei/agconnect/config/impl/Keys;->bytesXor([B[B)[B
