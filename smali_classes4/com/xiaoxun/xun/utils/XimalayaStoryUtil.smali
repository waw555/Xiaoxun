.class public Lcom/xiaoxun/xun/utils/XimalayaStoryUtil;
...
.method public static convertJsonToTrackList(Ljava/lang/String;Ljava/util/ArrayList;)Ljava/lang/String;
    .locals 17
    ...
    .line 1
    :try_start_0
    invoke-static/range {p0 .. p0}, Lnet/minidev/json/JSONValue;->parse(Ljava/lang/String;)Ljava/lang/Object;
    ...
    const-string v5, "online_media_playurl"

    const-string v6, "online_media_name"

    const-string v7, "online_media_provider"

    const-string v8, "size"

    const-string v9, "online_media_size"

    const-string v10, "duration"

    const-string v11, "online_media_duration"

    const-string v12, "provider"

    const-string v13, "coverUrl"

    const-string v14, "online_media_coverurl"

    if-eqz v3, :cond_1

    :try_start_1
    const-string v3, "currentPlayNo"
...
.method public static getTrackTotalSize(Ljava/util/List;)I
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    check-cast v1, Lcom/xiaoxun/xun/beans/WatchDownloadBean;
    ...
    .line 4
    invoke-virtual {v1}, Lcom/xiaoxun/xun/beans/WatchDownloadBean;->getSize()I
...
.method public static isDownload(Lcom/ximalaya/ting/android/opensdk/model/track/Track;Ljava/util/List;)Lcom/xiaoxun/xun/beans/WatchDownloadBean;
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static isHaveRepeatDownload(Lcom/xiaoxun/xun/ImibabyApp;Ljava/lang/String;Ljava/lang/String;)Z
    .locals 2
    ...
    const-string p1, "local_download"
...
.method public static isSupportM4a(Lcom/xiaoxun/xun/ImibabyApp;Lcom/xiaoxun/xun/beans/WatchData;)Z
    .locals 0
    ...
    invoke-virtual {p0}, Lcom/xiaoxun/xun/utils/ConfigData;->isSwitch_M4a()Z
...
.method public static saveDownloadDataToLocal(Lcom/xiaoxun/xun/ImibabyApp;Ljava/lang/String;Ljava/lang/String;)V
    .locals 4
