.class public Lcom/xiaoxun/xun/m/f;
.super Lcom/xiaoxun/xun/m/a;
.source "SourceFile"


# static fields
.field private static volatile c:Lcom/xiaoxun/xun/m/f;
...
.method private f(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    const-string v0, "CREATE TABLE life_message (_id INTEGER PRIMARY KEY AUTOINCREMENT,user_eid TEXT,message_id TEXT,message_title TEXT,message_content TEXT,message_type TEXT,picture_url TEXT,href_url TEXT,message_time TEXT,message_status INTEGER);"
...
.method public static i(Landroid/content/Context;)Lcom/xiaoxun/xun/m/f;
    .locals 2

    .line 1
    sget-object v0, Lcom/xiaoxun/xun/m/f;->c:Lcom/xiaoxun/xun/m/f;

    if-nez v0, :cond_1

    .line 2
    const-class v0, Lcom/xiaoxun/xun/m/f;

    monitor-enter v0

    .line 3
    :try_start_0
    sget-object v1, Lcom/xiaoxun/xun/m/f;->c:Lcom/xiaoxun/xun/m/f;

    if-nez v1, :cond_0

    .line 4
    new-instance v1, Lcom/xiaoxun/xun/m/f;

    invoke-direct {v1, p0}, Lcom/xiaoxun/xun/m/f;-><init>(Landroid/content/Context;)V

    sput-object v1, Lcom/xiaoxun/xun/m/f;->c:Lcom/xiaoxun/xun/m/f;
    ...
    :cond_1
    :goto_0
    sget-object p0, Lcom/xiaoxun/xun/m/f;->c:Lcom/xiaoxun/xun/m/f;
...
.method public e(Ljava/lang/String;Lcom/xiaoxun/xun/NoticeManage/message/system/bean/SystemMessage;)J
    ...
    .line 14
    :goto_0
    invoke-direct {p0, v0}, Lcom/xiaoxun/xun/m/f;->f(Landroid/database/sqlite/SQLiteDatabase;)V
...
.method public h(Ljava/lang/String;)Ljava/util/ArrayList;
    ...
    .line 25
    :catch_0
    invoke-direct {p0, v1}, Lcom/xiaoxun/xun/m/f;->f(Landroid/database/sqlite/SQLiteDatabase;)V
...
.method public l(Ljava/lang/String;Lcom/xiaoxun/xun/NoticeManage/message/system/bean/SystemMessage;I)V
    ...
    .line 25
    :catch_0
    invoke-direct {p0, v4}, Lcom/xiaoxun/xun/m/f;->f(Landroid/database/sqlite/SQLiteDatabase;)V
