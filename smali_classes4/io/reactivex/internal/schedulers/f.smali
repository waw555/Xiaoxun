...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lio/reactivex/internal/schedulers/f;->c:Ljava/util/concurrent/ScheduledExecutorService;
    ...
    sput-object v2, Lio/reactivex/internal/schedulers/f;->b:Lio/reactivex/internal/schedulers/RxThreadFactory;
...
.method public constructor <init>(Ljava/util/concurrent/ThreadFactory;)V
    ...
    iput-object v0, p0, Lio/reactivex/internal/schedulers/f;->a:Ljava/util/concurrent/atomic/AtomicReference;

    .line 4
    invoke-static {p1}, Lio/reactivex/internal/schedulers/f;->d(Ljava/util/concurrent/ThreadFactory;)Ljava/util/concurrent/ScheduledExecutorService;
...
.method static d(Ljava/util/concurrent/ThreadFactory;)Ljava/util/concurrent/ScheduledExecutorService;
    ...
    .line 1
    invoke-static {p0}, Lio/reactivex/internal/schedulers/e;->a(Ljava/util/concurrent/ThreadFactory;)Ljava/util/concurrent/ScheduledExecutorService;
...
.method public a()Lh/a/h$b;
    ...
    iget-object v1, p0, Lio/reactivex/internal/schedulers/f;->a:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    invoke-direct {v0, v1}, Lio/reactivex/internal/schedulers/f$a;-><init>(Ljava/util/concurrent/ScheduledExecutorService;)V
...
.method public c(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;)Lio/reactivex/disposables/b;
    ...
    .line 2
    :try_start_0
    iget-object p2, p0, Lio/reactivex/internal/schedulers/f;->a:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    .line 3
    :cond_0
    iget-object v0, p0, Lio/reactivex/internal/schedulers/f;->a:Ljava/util/concurrent/atomic/AtomicReference;
