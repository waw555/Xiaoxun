...
.method public static declared-synchronized getInstance(Lorg/joda/time/DateTimeZone;Lorg/joda/time/ReadableInstant;I)Lorg/joda/time/chrono/GJChronology;
    ...
    const-class v0, Lorg/joda/time/chrono/GJChronology;
    ...
    invoke-direct {v1, v2, v3, v4}, Lorg/joda/time/LocalDate;-><init>(JLorg/joda/time/Chronology;)V
    ...
    .line 10
    :try_start_1
    sget-object v2, Lorg/joda/time/chrono/GJChronology;->cCache:Ljava/util/Map;
    ...
    .line 12
    sget-object v3, Lorg/joda/time/chrono/GJChronology;->cCache:Ljava/util/Map;
    ...
    .line 15
    invoke-virtual {v4}, Lorg/joda/time/chrono/GJChronology;->getMinimumDaysInFirstWeek()I

    move-result v5

    if-ne p2, v5, :cond_2

    invoke-virtual {v4}, Lorg/joda/time/chrono/GJChronology;->getGregorianCutover()Lorg/joda/time/Instant;

    move-result-object v5

    invoke-virtual {p1, v5}, Lorg/joda/time/base/AbstractInstant;->equals(Ljava/lang/Object;)Z
    ...
    invoke-direct {v3, v4, p0, p1}, Lorg/joda/time/chrono/GJChronology;-><init>(Lorg/joda/time/chrono/JulianChronology;Lorg/joda/time/chrono/GregorianChronology;Lorg/joda/time/Instant;)V
    ...
    invoke-static {v3, p1, p2}, Lorg/joda/time/chrono/GJChronology;->getInstance(Lorg/joda/time/DateTimeZone;Lorg/joda/time/ReadableInstant;I)Lorg/joda/time/chrono/GJChronology;
    ...
    iget-object v4, p1, Lorg/joda/time/chrono/GJChronology;->iGregorianChronology:Lorg/joda/time/chrono/GregorianChronology;

    iget-object p1, p1, Lorg/joda/time/chrono/GJChronology;->iCutoverInstant:Lorg/joda/time/Instant;

    invoke-direct {v3, p0, p2, v4, p1}, Lorg/joda/time/chrono/GJChronology;-><init>(Lorg/joda/time/Chronology;Lorg/joda/time/chrono/JulianChronology;Lorg/joda/time/chrono/GregorianChronology;Lorg/joda/time/Instant;)V
...
.method protected assemble(Lorg/joda/time/chrono/AssembledChronology$Fields;)V
    ...
    iput-object v7, p1, Lorg/joda/time/chrono/AssembledChronology$Fields;->millisOfSecond:Lorg/joda/time/DateTimeField;
    ...
    iput-object v7, p1, Lorg/joda/time/chrono/AssembledChronology$Fields;->millisOfDay:Lorg/joda/time/DateTimeField;
    ...
    iput-object v7, p1, Lorg/joda/time/chrono/AssembledChronology$Fields;->secondOfMinute:Lorg/joda/time/DateTimeField;
    ...
    iput-object v7, p1, Lorg/joda/time/chrono/AssembledChronology$Fields;->secondOfDay:Lorg/joda/time/DateTimeField;
    ...
    iput-object v7, p1, Lorg/joda/time/chrono/AssembledChronology$Fields;->minuteOfHour:Lorg/joda/time/DateTimeField;
    ...
    iput-object v7, p1, Lorg/joda/time/chrono/AssembledChronology$Fields;->minuteOfDay:Lorg/joda/time/DateTimeField;
    ...
    iput-object v7, p1, Lorg/joda/time/chrono/AssembledChronology$Fields;->hourOfDay:Lorg/joda/time/DateTimeField;
    ...
    iput-object v7, p1, Lorg/joda/time/chrono/AssembledChronology$Fields;->hourOfHalfday:Lorg/joda/time/DateTimeField;
    ...
    iput-object v7, p1, Lorg/joda/time/chrono/AssembledChronology$Fields;->clockhourOfDay:Lorg/joda/time/DateTimeField;
    ...
    iput-object v7, p1, Lorg/joda/time/chrono/AssembledChronology$Fields;->clockhourOfHalfday:Lorg/joda/time/DateTimeField;
    ...
    iput-object v7, p1, Lorg/joda/time/chrono/AssembledChronology$Fields;->halfdayOfDay:Lorg/joda/time/DateTimeField;
    ...
    iput-object v7, p1, Lorg/joda/time/chrono/AssembledChronology$Fields;->era:Lorg/joda/time/DateTimeField;
    ...
    iput-object v7, p1, Lorg/joda/time/chrono/AssembledChronology$Fields;->dayOfYear:Lorg/joda/time/DateTimeField;
    ...
    iput-object v7, p1, Lorg/joda/time/chrono/AssembledChronology$Fields;->weekOfWeekyear:Lorg/joda/time/DateTimeField;
    ...
    iput-object v7, p1, Lorg/joda/time/chrono/AssembledChronology$Fields;->yearOfCentury:Lorg/joda/time/DateTimeField;
    ...
    iput-object v6, p1, Lorg/joda/time/chrono/AssembledChronology$Fields;->monthOfYear:Lorg/joda/time/DateTimeField;
    ...
    iput-object v9, p1, Lorg/joda/time/chrono/AssembledChronology$Fields;->weekyear:Lorg/joda/time/DateTimeField;
    ...
    iput-object v7, p1, Lorg/joda/time/chrono/AssembledChronology$Fields;->weekyearOfCentury:Lorg/joda/time/DateTimeField;
