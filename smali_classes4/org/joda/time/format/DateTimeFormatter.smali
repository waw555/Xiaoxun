...
.method private printTo(Ljava/io/Writer;JLorg/joda/time/Chronology;)V
    ...
    .line 24
    invoke-direct/range {p0 .. p0}, Lorg/joda/time/format/DateTimeFormatter;->requirePrinter()Lorg/joda/time/format/DateTimePrinter;
...
.method public parseDateTime(Ljava/lang/String;)Lorg/joda/time/DateTime;
    ...
    .line 4
    invoke-interface {v0, v9, p1, v2}, Lorg/joda/time/format/DateTimeParser;->parseInto(Lorg/joda/time/format/DateTimeParserBucket;Ljava/lang/String;I)I
...
.method public parseInto(Lorg/joda/time/ReadWritableInstant;Ljava/lang/String;I)I
    ...
    .line 8
    invoke-interface {v0, v2, p2, p3}, Lorg/joda/time/format/DateTimeParser;->parseInto(Lorg/joda/time/format/DateTimeParserBucket;Ljava/lang/String;I)I
...
.method public printTo(Ljava/io/Writer;Lorg/joda/time/ReadableInstant;)V
    ...
    .line 6
    invoke-direct {p0, p1, v0, v1, p2}, Lorg/joda/time/format/DateTimeFormatter;->printTo(Ljava/io/Writer;JLorg/joda/time/Chronology;)V
...
.method public printTo(Ljava/lang/StringBuffer;Lorg/joda/time/ReadableInstant;)V
    ...
    .line 3
    invoke-direct {p0, p1, v0, v1, p2}, Lorg/joda/time/format/DateTimeFormatter;->printTo(Ljava/lang/StringBuffer;JLorg/joda/time/Chronology;)V
...
.method public withChronology(Lorg/joda/time/Chronology;)Lorg/joda/time/format/DateTimeFormatter;
    ...
    iget-object v2, p0, Lorg/joda/time/format/DateTimeFormatter;->iPrinter:Lorg/joda/time/format/DateTimePrinter;

    iget-object v3, p0, Lorg/joda/time/format/DateTimeFormatter;->iParser:Lorg/joda/time/format/DateTimeParser;
    ...
    invoke-direct/range {v1 .. v9}, Lorg/joda/time/format/DateTimeFormatter;-><init>(Lorg/joda/time/format/DateTimePrinter;Lorg/joda/time/format/DateTimeParser;Ljava/util/Locale;ZLorg/joda/time/Chronology;Lorg/joda/time/DateTimeZone;Ljava/lang/Integer;I)V
...
.method public withOffsetParsed()Lorg/joda/time/format/DateTimeFormatter;
    ...
    iget-object v3, p0, Lorg/joda/time/format/DateTimeFormatter;->iPrinter:Lorg/joda/time/format/DateTimePrinter;

    iget-object v4, p0, Lorg/joda/time/format/DateTimeFormatter;->iParser:Lorg/joda/time/format/DateTimeParser;
    ...
    invoke-direct/range {v2 .. v10}, Lorg/joda/time/format/DateTimeFormatter;-><init>(Lorg/joda/time/format/DateTimePrinter;Lorg/joda/time/format/DateTimeParser;Ljava/util/Locale;ZLorg/joda/time/Chronology;Lorg/joda/time/DateTimeZone;Ljava/lang/Integer;I)V
