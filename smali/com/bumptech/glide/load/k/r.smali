...
.method public constructor <init>(Landroid/support/v4/util/Pools$Pool;)V
    ...
    invoke-direct {p0, p1, v0}, Lcom/bumptech/glide/load/k/r;-><init>(Landroid/support/v4/util/Pools$Pool;Lcom/bumptech/glide/load/k/r$c;)V

    return-void
.end method

.method constructor <init>(Landroid/support/v4/util/Pools$Pool;Lcom/bumptech/glide/load/k/r$c;)V
    .locals 1
    .param p1    # Landroid/support/v4/util/Pools$Pool;
        .annotation build Landroid/support/annotation/NonNull;
        .end annotation
    ...
    .line 5
    iput-object p1, p0, Lcom/bumptech/glide/load/k/r;->d:Landroid/support/v4/util/Pools$Pool;
...
.method public declared-synchronized d(Ljava/lang/Class;Ljava/lang/Class;)Lcom/bumptech/glide/load/k/n;
    ...
    iget-object p2, p0, Lcom/bumptech/glide/load/k/r;->d:Landroid/support/v4/util/Pools$Pool;

    invoke-virtual {p1, v0, p2}, Lcom/bumptech/glide/load/k/r$c;->a(Ljava/util/List;Landroid/support/v4/util/Pools$Pool;)Lcom/bumptech/glide/load/k/q;
...
.method declared-synchronized j(Ljava/lang/Class;Ljava/lang/Class;Lcom/bumptech/glide/load/k/o;)Ljava/util/List;
    .locals 1
    .param p1    # Ljava/lang/Class;
        .annotation build Landroid/support/annotation/NonNull;
        .end annotation
    ...
    .line 1
    :try_start_0
    invoke-virtual {p0, p1, p2}, Lcom/bumptech/glide/load/k/r;->i(Ljava/lang/Class;Ljava/lang/Class;)Ljava/util/List;
