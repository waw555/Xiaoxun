...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/amap/api/mapcore/util/j;->c:Ljava/util/List;

    const-wide v0, 0x415854c140000000L    # 6378245.0

    .line 2
    sput-wide v0, Lcom/amap/api/mapcore/util/j;->d:D

    const-wide v0, 0x3f7b6a8faf80ef0bL    # 0.006693421622965943

    .line 3
    sput-wide v0, Lcom/amap/api/mapcore/util/j;->e:D
...
.method private static a(D)D
    ...
    .line 1
    sget-wide v0, Lcom/amap/api/mapcore/util/j;->b:D
...
.method public static c(Landroid/content/Context;Lcom/amap/api/maps/model/LatLng;)Lcom/amap/api/maps/model/LatLng;
    ...
    invoke-static {v0, v1, v2, v3}, Lcom/amap/api/mapcore/util/l3;->a(DD)Z
    ...
    sget-boolean p1, Lcom/amap/api/mapcore/util/j;->a:Z

    invoke-static {p0, p1}, Lcom/amap/api/mapcore/util/j;->f(Lcom/autonavi/amap/mapcore/DPoint;Z)Lcom/autonavi/amap/mapcore/DPoint;
...
.method public static d(Lcom/amap/api/maps/model/LatLng;)Lcom/amap/api/maps/model/LatLng;
    ...
    invoke-static {v2, v3, v4, v5}, Lcom/amap/api/mapcore/util/j;->l(DD)Lcom/autonavi/amap/mapcore/DPoint;
    ...
    .line 7
    sget-object v2, Lcom/amap/api/mapcore/util/j;->c:Ljava/util/List;

    invoke-static {v0, v2}, Lcom/amap/api/mapcore/util/s3;->S(Lcom/amap/api/maps/model/LatLng;Ljava/util/List;)Z
    ...
    .line 11
    sget-wide v26, Lcom/amap/api/mapcore/util/j;->b:D
    ...
    sget-wide v30, Lcom/amap/api/mapcore/util/j;->b:D
    ...
    sget-wide v32, Lcom/amap/api/mapcore/util/j;->b:D
    ...
    .line 13
    sget-wide v36, Lcom/amap/api/mapcore/util/j;->b:D
    ...
    .line 15
    sget-wide v8, Lcom/amap/api/mapcore/util/j;->b:D
    ...
    sget-wide v18, Lcom/amap/api/mapcore/util/j;->b:D
    ...
    .line 18
    sget-wide v14, Lcom/amap/api/mapcore/util/j;->b:D
    ...
    .line 20
    sget-wide v16, Lcom/amap/api/mapcore/util/j;->e:D
    ...
    .line 22
    sget-wide v20, Lcom/amap/api/mapcore/util/j;->d:D

    sget-wide v22, Lcom/amap/api/mapcore/util/j;->e:D
    ...
    .line 23
    sget-wide v6, Lcom/amap/api/mapcore/util/j;->d:D
...
.method private static e(DDDD)Lcom/autonavi/amap/mapcore/DPoint;
    ...
    .line 2
    invoke-static {p4, p5, p6, p7}, Lcom/amap/api/mapcore/util/j;->k(DD)Lcom/autonavi/amap/mapcore/DPoint;
    ...
    invoke-static {p0, p1}, Lcom/amap/api/mapcore/util/j;->j(D)D
    ...
    invoke-static {p2, p3}, Lcom/amap/api/mapcore/util/j;->j(D)D
...
.method public static i(Landroid/content/Context;Lcom/amap/api/maps/model/LatLng;)Lcom/amap/api/maps/model/LatLng;
    ...
    .line 5
    invoke-static {v2, v3, v4, v5}, Lcom/amap/api/mapcore/util/j;->b(DD)D
    ...
    .line 6
    invoke-static {v2, v3, v4, v5}, Lcom/amap/api/mapcore/util/j;->h(DD)D
    ...
    .line 7
    invoke-static {v9, v10, v11, v12}, Lcom/amap/api/mapcore/util/j;->b(DD)D
    ...
    .line 8
    invoke-static {v2, v3, v11, v12}, Lcom/amap/api/mapcore/util/j;->h(DD)D
    ...
    invoke-static {v2, v8}, Lcom/amap/api/mapcore/util/j;->c(Landroid/content/Context;Lcom/amap/api/maps/model/LatLng;)Lcom/amap/api/maps/model/LatLng;
...
.method private static k(DD)Lcom/autonavi/amap/mapcore/DPoint;
    ...
    .line 2
    invoke-static {p0, p1}, Lcom/amap/api/mapcore/util/j;->g(D)D
    ...
    .line 3
    invoke-static {p2, p3}, Lcom/amap/api/mapcore/util/j;->a(D)D
    ...
    .line 6
    invoke-static {v1, v2}, Lcom/amap/api/mapcore/util/j;->j(D)D
...
.method private static l(DD)Lcom/autonavi/amap/mapcore/DPoint;
    ...
    .line 1
    invoke-static/range {v6 .. v13}, Lcom/amap/api/mapcore/util/j;->e(DDDD)Lcom/autonavi/amap/mapcore/DPoint;
