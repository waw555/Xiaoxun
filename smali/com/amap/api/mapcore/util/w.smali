.class public final Lcom/amap/api/mapcore/util/w;
...
.field private c:Lcom/amap/api/mapcore/util/h4;

.field private d:Lcom/autonavi/amap/mapcore/Inner_3dMap_locationOption;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 2
    iput-object v0, p0, Lcom/amap/api/mapcore/util/w;->a:Landroid/os/Bundle;
    ...
    .line 4
    iput-wide v0, p0, Lcom/amap/api/mapcore/util/w;->f:J

    .line 5
    iput-object p1, p0, Lcom/amap/api/mapcore/util/w;->g:Landroid/content/Context;
...
.method private c(Z)V
    ...
    .line 1
    iget-object v0, p0, Lcom/amap/api/mapcore/util/w;->d:Lcom/autonavi/amap/mapcore/Inner_3dMap_locationOption;

    if-eqz v0, :cond_1

    iget-object v0, p0, Lcom/amap/api/mapcore/util/w;->c:Lcom/amap/api/mapcore/util/h4;

    if-eqz v0, :cond_1

    .line 2
    invoke-virtual {v0}, Lcom/amap/api/mapcore/util/h4;->e()V

    .line 3
    new-instance v0, Lcom/amap/api/mapcore/util/h4;

    iget-object v1, p0, Lcom/amap/api/mapcore/util/w;->g:Landroid/content/Context;

    invoke-direct {v0, v1}, Lcom/amap/api/mapcore/util/h4;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lcom/amap/api/mapcore/util/w;->c:Lcom/amap/api/mapcore/util/h4;

    .line 4
    invoke-virtual {v0, p0}, Lcom/amap/api/mapcore/util/h4;->b(Lcom/autonavi/amap/mapcore/Inner_3dMap_locationListener;)V
    ...
    iget-wide v1, p0, Lcom/amap/api/mapcore/util/w;->f:J
    ...
    iget-object v1, p0, Lcom/amap/api/mapcore/util/w;->d:Lcom/autonavi/amap/mapcore/Inner_3dMap_locationOption;

    invoke-virtual {v0, v1}, Lcom/amap/api/mapcore/util/h4;->c(Lcom/autonavi/amap/mapcore/Inner_3dMap_locationOption;)V

    .line 8
    iget-object v0, p0, Lcom/amap/api/mapcore/util/w;->c:Lcom/amap/api/mapcore/util/h4;

    invoke-virtual {v0}, Lcom/amap/api/mapcore/util/h4;->a()V
...
.method public final a(I)V
    ...
    .line 1
    invoke-direct {p0, p1}, Lcom/amap/api/mapcore/util/w;->c(Z)V
    ...
    :cond_1
    :goto_0
    invoke-direct {p0, v0}, Lcom/amap/api/mapcore/util/w;->c(Z)V
...
.method public final activate(Lcom/amap/api/maps/LocationSource$OnLocationChangedListener;)V
    ...
    .line 1
    iput-object p1, p0, Lcom/amap/api/mapcore/util/w;->b:Lcom/amap/api/maps/LocationSource$OnLocationChangedListener;

    .line 2
    iget-object p1, p0, Lcom/amap/api/mapcore/util/w;->c:Lcom/amap/api/mapcore/util/h4;

    if-nez p1, :cond_0

    .line 3
    new-instance p1, Lcom/amap/api/mapcore/util/h4;

    iget-object v0, p0, Lcom/amap/api/mapcore/util/w;->g:Landroid/content/Context;

    invoke-direct {p1, v0}, Lcom/amap/api/mapcore/util/h4;-><init>(Landroid/content/Context;)V

    iput-object p1, p0, Lcom/amap/api/mapcore/util/w;->c:Lcom/amap/api/mapcore/util/h4;
    ...
    iput-object p1, p0, Lcom/amap/api/mapcore/util/w;->d:Lcom/autonavi/amap/mapcore/Inner_3dMap_locationOption;

    .line 5
    iget-object p1, p0, Lcom/amap/api/mapcore/util/w;->c:Lcom/amap/api/mapcore/util/h4;

    invoke-virtual {p1, p0}, Lcom/amap/api/mapcore/util/h4;->b(Lcom/autonavi/amap/mapcore/Inner_3dMap_locationListener;)V

    .line 6
    iget-object p1, p0, Lcom/amap/api/mapcore/util/w;->d:Lcom/autonavi/amap/mapcore/Inner_3dMap_locationOption;

    iget-wide v0, p0, Lcom/amap/api/mapcore/util/w;->f:J
    ...
    invoke-virtual {p1, v0}, Lcom/amap/api/mapcore/util/h4;->c(Lcom/autonavi/amap/mapcore/Inner_3dMap_locationOption;)V

    .line 10
    iget-object p1, p0, Lcom/amap/api/mapcore/util/w;->c:Lcom/amap/api/mapcore/util/h4;

    invoke-virtual {p1}, Lcom/amap/api/mapcore/util/h4;->a()V
...
.method public final b(J)V
    ...
    iget-object v1, p0, Lcom/amap/api/mapcore/util/w;->c:Lcom/amap/api/mapcore/util/h4;
    ...
    .line 5
    :cond_0
    iput-wide p1, p0, Lcom/amap/api/mapcore/util/w;->f:J
...
.method public final deactivate()V
    ...
    .line 1
    iput-object v0, p0, Lcom/amap/api/mapcore/util/w;->b:Lcom/amap/api/maps/LocationSource$OnLocationChangedListener;
    ...
    .line 3
    invoke-virtual {v1}, Lcom/amap/api/mapcore/util/h4;->d()V

    .line 4
    iget-object v1, p0, Lcom/amap/api/mapcore/util/w;->c:Lcom/amap/api/mapcore/util/h4;

    invoke-virtual {v1}, Lcom/amap/api/mapcore/util/h4;->e()V
...
.method public final onLocationChanged(Lcom/autonavi/amap/mapcore/Inner_3dMap_location;)V
    ...
    .line 1
    :try_start_0
    iget-object v0, p0, Lcom/amap/api/mapcore/util/w;->b:Lcom/amap/api/maps/LocationSource$OnLocationChangedListener;
    ...
    .line 4
    :cond_0
    iget-object v0, p0, Lcom/amap/api/mapcore/util/w;->a:Landroid/os/Bundle;
