.class final Lcom/amap/api/mapcore/util/v$a;
...
.method constructor <init>(Lcom/amap/api/mapcore/util/v;)V
    ...
    .line 1
    iput-object p1, p0, Lcom/amap/api/mapcore/util/v$a;->a:Lcom/amap/api/mapcore/util/v;
...
.method public final getInfoWindow(Lcom/amap/api/maps/model/Marker;)Landroid/view/View;
    ...
    .line 1
    :try_start_0
    iget-object v0, p0, Lcom/amap/api/mapcore/util/v$a;->a:Lcom/amap/api/mapcore/util/v;
    ...
    iget-object v1, p0, Lcom/amap/api/mapcore/util/v$a;->a:Lcom/amap/api/mapcore/util/v;

    iget-object v1, v1, Lcom/amap/api/mapcore/util/v;->h:Landroid/content/Context;

    const-string v2, "infowindow_bg.9.png"

    invoke-static {v1, v2}, Lcom/amap/api/mapcore/util/h3;->b(Landroid/content/Context;Ljava/lang/String;)Landroid/graphics/drawable/Drawable;

    move-result-object v1

    invoke-static {v0, v1}, Lcom/amap/api/mapcore/util/v;->b(Lcom/amap/api/mapcore/util/v;Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    iget-object v2, p0, Lcom/amap/api/mapcore/util/v$a;->a:Lcom/amap/api/mapcore/util/v;

    iget-object v2, v2, Lcom/amap/api/mapcore/util/v;->h:Landroid/content/Context;

    invoke-direct {v1, v2}, Landroid/widget/LinearLayout;-><init>(Landroid/content/Context;)V

    invoke-static {v0, v1}, Lcom/amap/api/mapcore/util/v;->c(Lcom/amap/api/mapcore/util/v;Landroid/view/View;)Landroid/view/View;
    ...
    invoke-static {v1}, Lcom/amap/api/mapcore/util/v;->a(Lcom/amap/api/mapcore/util/v;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {v0, v1}, Lcom/amap/api/mapcore/util/v;->f(Lcom/amap/api/mapcore/util/v;Landroid/widget/TextView;)Landroid/widget/TextView;
    ...
    iget-object v3, p0, Lcom/amap/api/mapcore/util/v$a;->a:Lcom/amap/api/mapcore/util/v;

    iget-object v3, v3, Lcom/amap/api/mapcore/util/v;->h:Landroid/content/Context;

    invoke-direct {v2, v3}, Landroid/widget/TextView;-><init>(Landroid/content/Context;)V

    invoke-static {v0, v2}, Lcom/amap/api/mapcore/util/v;->p(Lcom/amap/api/mapcore/util/v;Landroid/widget/TextView;)Landroid/widget/TextView;
    ...
    .line 12
    iget-object p1, p0, Lcom/amap/api/mapcore/util/v$a;->a:Lcom/amap/api/mapcore/util/v;
